...
namespace Gauniv.WebServer.Migrations
{
    ...
    [Migration("20250225210349_InitialMigration")]
            ...
            modelBuilder.Entity("GameUser", b =>
                {
                    ...
                    b.Property<int>("PurchasedGamesId")
                        .HasColumnType("integer");

                    b.HasKey("PurchasedById", "PurchasedGamesId");

                    b.HasIndex("PurchasedGamesId");
            ...
            modelBuilder.Entity("GameUser", b =>
                {
                    ...
                    b.HasOne("Gauniv.WebServer.Data.Game", null)
                        .WithMany()
                        .HasForeignKey("PurchasedGamesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
